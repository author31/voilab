...
class KitchenTaskRegistry:
    ...
    PRELOAD_OBJECTS = [
        {"name": "pink cup", "assets": "cup_pink.usd", "prim_path": "/World/pink_cup", "default_position": [4.99475193, 2.55671889, 1.1]},
        {"name": "blue cup", "assets": "cup_blue.usd", "prim_path": "/World/blue_cup", "default_position": [4.96726411, 2.52940216, 1.1]},
    ]
    #[ObjectLoader] Positioned blue_cup at [4.96726411, 2.52940216, 1.1]
    #[ObjectLoader] Positioned pink_cup at [4.99475193, 2.55671889, 1.1]
    # Robot poses (Franka)
